@if ($paginator->hasPages())
    <div class="px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mt-6 text-base font-medium text-gray-900 dark:text-gray-200">
            {{-- 📊 Info jumlah data --}}
            <div>
                Menampilkan {{ $paginator->firstItem() }}–{{ $paginator->lastItem() }} dari {{ $paginator->total() }} Notifikasi
            </div>
