...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ config('app.name', 'BerauCool') }}</title>

        {{-- 2. Menambahkan link ke favicon Anda --}}
    ...
    <body class="font-sans antialiased">
        <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
            ...
            <div class="max-w-7xl mx-auto p-6 lg:p-8">
                {{-- Di sini Anda bisa menaruh logo atau konten utama halaman selamat datang --}}
                <h1 class="text-4xl font-bold dark:text-white">Welcome to AuditApp</h1>
            </div>
        </div>
    </body>
</html>